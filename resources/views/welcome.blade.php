                            ...
                            <div class="col-md-6">
                                <div class="card m-3 house-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="grey"><h4>/- {{ $house->rent }} KSH</i></h4> </p>
                                    </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              ...
              <p class="pera">We are the number one online house renting service having been in business for the last 10 years. We are trusted by Locals as well as foreigners </p>
